# Orientações - Prova Programação [01/09/2022 - 10:30 - 12:00]
...
```html
https://github.com/ldmfabio/if_ternario_switch_case_1INFO1.git
```
*Ou então*, no terminal do VSCode, digite:
```GIT
git clone https://github.com/ldmfabio/if_ternario_switch_case_1INFO1.git
```
